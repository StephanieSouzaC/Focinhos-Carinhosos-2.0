...
//       setModalMessage("Cadastro atualizado com sucesso!"); // Define a mensagem de sucesso
//     } catch (err) {
//       setModalMessage("Erro ao atualizar cadastro: " + err.message); // Define a mensagem de erro
//     } finally {
